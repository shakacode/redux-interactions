...
const UPDATE_REQUESTED = 'POST_FORM # SERVER_STATE_UPDATE_REQUESTED';
const UPDATE_SUCCEEDED = 'POST_FORM # SERVER_STATE_UPDATE_SUCCEEDED';
const UPDATE_FAILED = 'POST_FORM # SERVER_STATE_UPDATE_FAILED';
...
// Reducer handler
type OnRequest = {
  [typeof UPDATE_REQUESTED]: ReducerHandler<StoreState, RequestAction>,
};
...
type OnSuccess = {
  [typeof UPDATE_SUCCEEDED]: ReducerHandler<StoreState, SuccessAction>,
};
...
// Reducer handler -> data/postsStore: update entity in posts data store
type UpdatePostOnEdit = {
  [typeof UPDATE_SUCCEEDED]: ReducerHandler<PostsStoreState, SuccessAction>,
};
...
// Reducer handler
type OnFailure = {
  [typeof UPDATE_FAILED]: ReducerHandler<StoreState, FailureAction>,
};
